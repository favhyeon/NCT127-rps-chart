...
const ownInitials = ["쟌", "툥", "윹", "도", "재", "젱", "맠", "동"];
...
const pairNames = [
    ...
    ["젱쟌", "젱툥", "젱윹", "젱두", "젱재", "젱젱", "정맠", "젱동"],
    ["맠쟌", "맠툥", "맠윹", "맠도", "맠재", "맠정", "맠맠", "맠동"],
    ["동쟌", "동툥", "동윹", "썬끼", "해재", "동정", "동맠", "동동"]
];
...
/* ==========================================
   ...
   칠페스: 이 사이트(NCT127). 드페스: NCT DREAM, 웨페스: NCT WayV, 잇페스: NCT WISH.
   체크박스 5개는 라디오처럼 한 번에 하나만 선택되고, 다른 유닛을 선택하면
   해당 그룹의 취향표 주소로 이동한다.
========================================== */

const CURRENT_UNIT = "chil";
